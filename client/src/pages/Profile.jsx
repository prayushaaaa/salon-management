...
const UserProfilePage = () => {
    ...
    if (!isEmployee) {
        allAppointments = appointments.filter(appointment => appointment.user == user._id);
    }
    else {
        allAppointments = appointments.filter(appointment => appointment.employee == user._id);
        const { data: employee, loading, error } = useFetch(`${BASE_URL}/${user._id}`);
