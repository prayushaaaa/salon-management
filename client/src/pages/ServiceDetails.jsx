        ...
        <div className='max-w-[1170px] px-5 mx-auto'>
...

            {
                !loading && !error && <div className='grid md:grid-cols-3 gap-[50px]'>
                            ...
                            <div>
                                ...
                                <div className='flex items-center gap-[6px]'>
                                    <span className='flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'>
                                        <img src={starIcon} alt='' className='w-[15px] h-[15px]' /> {service.averageRating}
                                    </span>
                                    <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor'>
                                        ({service.totalRating})
                                    </span>
                                </div>
                                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>{service.desc}</p>
                    ...
                    <div>
                        <SidePanel key={service._id} price={service.price} points={service.points} />
                    </div>
